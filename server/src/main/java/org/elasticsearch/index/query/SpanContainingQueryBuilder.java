...
/**
 * Builder for SpanContainingQuery (removed in Lucene 9.x).
 */
public class SpanContainingQueryBuilder extends AbstractQueryBuilder<SpanContainingQueryBuilder> implements SpanQueryBuilder {
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        throw new UnsupportedOperationException("span_containing queries are not supported in Lucene 9.x - spans API was removed");
    }
