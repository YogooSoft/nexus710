...
public class TestBlendedTermQuery extends ESTestCase {
    ...
    public void testExtractTerms() throws IOException {
        ...
        new IndexSearcher(new MultiReader()).rewrite(blendedTermQuery).visit(QueryVisitor.termCollector(extracted));
